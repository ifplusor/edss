...
void mycondition_wait(mycondition_t theCondition_t,
                      mymutex_t theMutex_t,
                      int timeout) {
...
void MCDisposeCondition(MyCondition *theCondition) {
  kern_return_t
      ret = mach_port_destroy(mach_task_self(), theCondition->fWaitPort);
