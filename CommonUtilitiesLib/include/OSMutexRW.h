...
class OSMutexReadLocker : public OSMutexReadWriteLocker {
 public:
  ...
  OSMutexReadLocker(OSMutexRW *inMutexPtr)
      : OSMutexReadWriteLocker(inMutexPtr) {
    if (OSMutexReadWriteLocker::fRWMutexPtr != nullptr)
      OSMutexReadWriteLocker::fRWMutexPtr->LockRead();
  }
...
class OSMutexWriteLocker : public OSMutexReadWriteLocker {
 public:
  ...
  OSMutexWriteLocker(OSMutexRW *inMutexPtr)
      : OSMutexReadWriteLocker(inMutexPtr) {
    if (OSMutexReadWriteLocker::fRWMutexPtr != nullptr)
