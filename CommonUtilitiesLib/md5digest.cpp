...
void CalcMD5HA1(StrPtrLen *userName,
  ...
  Assert(hashA1Hex16Bit->Ptr
             == NULL); //This is the result. A Ptr here will be replaced. Value should be NULL.
...
// allocates memory to hA1->Ptr
void CalcHA1Md5Sess(StrPtrLen *hashA1Hex16Bit,
                    StrPtrLen *nonce,
                    StrPtrLen *cNonce,
                    StrPtrLen *hA1) {
  // parameters must be valid pointers
