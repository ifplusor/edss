...
EasyProtocol::MsgType EasyProtocol::MsgTypeMap[] = {
    ...
    MSG_SC_SERVER_GET_THRID_PART_PLATFORM_ACK,
    "MSG_SC_SERVER_GET_THRID_PART_PLATFORM_ACK",
    MSG_SC_SERVER_SET_THRID_PART_PLATFORM_ACK,
    "MSG_SC_SERVER_SET_THRID_PART_PLATFORM_ACK",
    MSG_SC_SERVER_GET_CHANNELS_ACK, "MSG_SC_SERVER_GET_CHANNELS_ACK",
    MSG_SC_SERVER_GET_CHANNELS_CONFIG_ACK,
    "MSG_SC_SERVER_GET_CHANNELS_CONFIG_ACK",
    MSG_SC_SERVER_SET_CHANNEL_CONFIG_ACK,
    "MSG_SC_SERVER_SET_CHANNEL_CONFIG_ACK",
    MSG_SC_SERVER_GET_CHANNEL_STREAM_ACK,
    "MSG_SC_SERVER_GET_CHANNEL_STREAM_ACK",
    ...
    MSG_SC_SERVER_TOUCH_CHANNEL_STREAM_ACK,
    "MSG_SC_SERVER_TOUCH_CHANNEL_STREAM_ACK",
    ...
    MSG_SC_SERVER_GET_RECORD_PATH_LIST_ACK,
    "MSG_SC_SERVER_GET_RECORD_PATH_LIST_ACK",
    MSG_SC_SERVER_ADD_RECORD_PATH_ACK, "MSG_SC_SERVER_ADD_RECORD_PATH_ACK",
    MSG_SC_SERVER_REMOVE_RECORD_PATH_ACK,
    "MSG_SC_SERVER_REMOVE_RECORD_PATH_ACK",
...
EasyProtocol::EasyProtocol(int iMsgType)
  ...
  root[EASY_TAG_ROOT][EASY_TAG_HEADER][EASY_TAG_MESSAGE_TYPE] =
      GetMsgTypeString(fMsgType);
}
...
int EasyProtocol::GetMessageType() {
  std::string sMessageType =
      root[EASY_TAG_ROOT][EASY_TAG_HEADER][EASY_TAG_MESSAGE_TYPE].asString();
...
int EasyProtocol::GetAppType() {
  std::string sAppType =
      root[EASY_TAG_ROOT][EASY_TAG_HEADER][EASY_TAG_APP_TYPE].asString();

  return GetAppType(sAppType);
}

int EasyProtocol::GetTerminalType() {
  std::string sTerminalType =
      root[EASY_TAG_ROOT][EASY_TAG_HEADER][EASY_TAG_TERMINAL_TYPE].asString();
...
int EasyProtocol::GetMsgCSeq() {
  std::string
      cseq = root[EASY_TAG_ROOT][EASY_TAG_HEADER][EASY_TAG_CSEQ].asString();
