...
typedef unordered_map<string, EasyDevice>
    EasyDevices;        //����ͷ����Ϊmap.������ҡ�keyΪchannel_��valueΪEasyDevice

typedef boost::variant<int, float, string> value_t;
typedef unordered_map<string, value_t>
    EasyJsonValue;    //keyΪstring,value������int��float��string��һ��
...
{
 public:
  EasyMsgDSRegisterREQ(EasyDarwinTerminalType terminalType,
...
{
 public:
  EasyMsgSDRegisterACK(EasyJsonValue &body,
                       size_t cseq = 1,
                       size_t error = 200);
...
class EasyMsgDSPushSteamACK : public EasyProtocol {
 public:
  EasyMsgDSPushSteamACK(EasyJsonValue &body,
                        size_t cseq = 1,
                        size_t error = 200);
...
class EasyMsgDSStopStreamACK : public EasyProtocol {
 public:
  EasyMsgDSStopStreamACK(EasyJsonValue &body,
                         size_t cseq = 1,
                         size_t error = 200);
...
class EasyMsgSCDeviceListACK : public EasyProtocol {
 public:
  EasyMsgSCDeviceListACK(EasyDevices &devices,
                         size_t cseq = 1,
                         size_t error = 200);
...
class EasyMsgSCDeviceInfoACK : public EasyProtocol {
 public:
  EasyMsgSCDeviceInfoACK(EasyDevices &cameras,
                         const string &devcei_serial,
                         size_t cseq = 1,
                         size_t error = 200);
...
class EasyMsgSCGetStreamACK : public EasyProtocol {
 public:
  EasyMsgSCGetStreamACK(EasyJsonValue &body,
                        size_t cseq = 1,
                        size_t error = 200);
...
class EasyMsgSCFreeStreamACK : public EasyProtocol {
 public:
  EasyMsgSCFreeStreamACK(EasyJsonValue &body,
                         size_t cseq = 1,
                         size_t error = 200);
...
class EasyMsgSDPostSnapACK : public EasyProtocol {
 public:
  EasyMsgSDPostSnapACK(EasyJsonValue &body,
                       size_t cseq = 1,
                       size_t error = 200);
...
class EasyMsgSCPTZControlACK : public EasyProtocol {
 public:
  EasyMsgSCPTZControlACK(EasyJsonValue &body,
                         size_t cseq = 1,
                         size_t error = 200);
...
class EasyMsgDSControlPTZACK : public EasyProtocol {
 public:
  EasyMsgDSControlPTZACK(EasyJsonValue &body,
                         size_t cseq = 1,
                         size_t error = 200);
...
class EasyMsgSCPresetControlACK : public EasyProtocol {
 public:
  EasyMsgSCPresetControlACK(EasyJsonValue &body,
                            size_t cseq = 1,
                            size_t error = 200);
...
class EasyMsgDSControlPresetACK : public EasyProtocol {
 public:
  EasyMsgDSControlPresetACK(EasyJsonValue &body,
                            size_t cseq = 1,
                            size_t error = 200);
...
class EasyMsgSCTalkbackControlACK : public EasyProtocol {
 public:
  EasyMsgSCTalkbackControlACK(EasyJsonValue &body,
                              size_t cseq = 1,
                              size_t error = 200);
...
class EasyMsgDSControlTalkbackACK : public EasyProtocol {
 public:
  EasyMsgDSControlTalkbackACK(EasyJsonValue &body,
                              size_t cseq = 1,
                              size_t error = 200);
...
class Easy_API EasyMsgSCRecordListACK : public EasyProtocolACK//��װ¼���б��Ӧ
{
 public:
  ...
  void AddRecord(const string &starttime,
                 const string &endtime);//format-HH:MM:SS
};

class EasyDarwinRecordSession {
 public:
  EasyDarwinRecordSession()
      : index(0), startTime(0), endTime(0), numOutputs(0) {
  }
...
class strDevice//�豸���Ͷ�Ӧ����Ϣ
{
 public:
  ...
  void HoldSnapPath(const string &strJpgPath,
                    const string &strChannel);//�������յ�·��
 public:
  string serial_;//�豸���к�
  string name_;//�豸����
  string password_;//����
