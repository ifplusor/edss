...
class Easy_API EasyUtil {
 public:
  static std::string TimeT2String(EasyDarwinTimeFormat whatFormat,
                                  unsigned long time);
  ...
  static unsigned long String2TimeT(EasyDarwinTimeFormat whatFormat,
                                    const std::string &timeString);

  static unsigned long String2TimeT(const std::string &dateYYMMDD/*2014-11-23*/,
  ...
  static string &ReplaceInPlace(string &str,
                                const string &from,
                                const string &to,
