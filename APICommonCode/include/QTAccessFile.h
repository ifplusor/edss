...
class QTAccessFile {
 public:
  ...
  virtual bool HaveGroups(char **groupArray,
                          UInt32 numGroups,
                          void *extraDataPtr);
  virtual bool HaveRealm(char *userName,
                         StrPtrLen *ioRealmNameStr,
                         void *extraData);
  virtual bool TestUser(StrPtrLen *accessUser,
                        char *userName,
                        void *extraDataPtr);
  virtual bool TestGroup(StrPtrLen *accessGroup,
                         char *userName,
                         char **groupArray,
                         UInt32 numGroups,
                         void *extraDataPtr);
  virtual bool TestExtraData(StrPtrLen *wordPtr,
                             StringParser *lineParserPtr,
                             void *extraDataPtr);
  virtual void GetRealm(StrPtrLen *accessRealm,
                        StrPtrLen *ioRealmNameStr,
                        char *userName,
                        void *extraDataPtr);
  ...
  bool AccessAllowed(char *userName,
                     char **groupArray,
                     UInt32 numGroups,
  ...
  static QTSS_AuthScheme FindUsersAndGroupsFilesAndAuthScheme(char *inAccessFilePath,
