...
class QTAtom_hinf : public QTAtom {
 ...
 public:
  ...
  inline UInt64 GetTotalRTPBytes() {
    return fTotalRTPBytes32 ? (UInt64) fTotalRTPBytes32 : fTotalRTPBytes64;
  }
  inline UInt64 GetTotalRTPPackets() {
    return fTotalRTPPackets32 ? (UInt64) fTotalRTPPackets32
                              : fTotalRTPPackets64;
  }

  inline UInt64 GetTotalPayLoadBytes() {
    return fTotalPayLoadBytes32 ? (UInt64) fTotalPayLoadBytes32
                                : fTotalPayLoadBytes64;
  }
