...
QTTrack::ErrorCode QTHintTrack::GetPacket(UInt32 sampleNumber,
  ...
  *transmitTime +=
  ...
  if (hdrData.hintFlags) {   //qtss_printf( "QTHintTrack::GetPacket hintFlags %lx\n", (SInt32)hdrData.hintFlags );
  }

  if (hdrData.hintFlags & kRepeatPacketMask
      && (dropRepeatPackets)) {   //qtss_printf( "QTHintTrack::GetPacket repeat packet dropped.\n" );
  ...
  for (UInt32 fieldCount = 0; fieldCount < RTPMetaInfoPacket::kNumFields;
    ...
    switch (fieldCount) {
      case RTPMetaInfoPacket::kPacketPosField: {
        SInt64 curPacketPos =
            OS::HostToNetworkSInt64(htcb->fCurrentPacketPosition);
      ...
      case RTPMetaInfoPacket::kTransTimeField: {
        SInt64 transmitTimeInMsec =
            OS::HostToNetworkSInt64((SInt64) (*transmitTime * 1000));
      ...
      case RTPMetaInfoPacket::kPacketNumField: {
        SInt64
            curPacketNum = OS::HostToNetworkSInt64(htcb->fCurrentPacketNumber);
