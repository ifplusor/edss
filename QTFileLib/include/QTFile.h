...
class QTFile {
 ...
 protected:
  ...
  CF::FileSource *fOSFileSourceFD;
#else
  CF::FileSource        fMovieFD;
#endif
  bool fCacheBuffersSet;

  CF::DateBuffer fModDateBuffer;
  char *fMoviePath;
...
bool QTFile::ValidTOC() {
  ...
  (void) QTSS_GetValue(fMovieFD,
                       ...
                       (void *) &thePos,
                       &theDataLen);
  //  s_printf("GenerateAtomTOC failed CurPos=%"_64BITARG_"u < Length=%"_64BITARG_"u\n", CurPos, theLength);
#else
