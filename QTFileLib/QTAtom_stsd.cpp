...
//
QTAtom_stsd::QTAtom_stsd(QTFile *File,
...
// Accessors
//
bool QTAtom_stsd::FindSampleDescription(OSType DataFormat,
                                        char **Buffer,
                                        UInt32 *Length) {
  // Temporary vars
  UInt32 tempInt32;
...
void QTAtom_stsd::DumpAtom() {
  ...
  DEBUG_PRINT(("QTAtom_stsd::DumpAtom - ..Number of sample description entries: %"
                  _S32BITARG_
                  "\n", fNumEntries));
}
