...
class RTPPacketResender {
 public:
  ...
  void SetDestination(CF::Net::UDPSocket *inOutputSocket,
                      UInt32 inDestAddr,
                      UInt16 inDestPort);

  void SetBandwidthTracker(RTPBandwidthTracker *inTracker) {
    fBandwidthTracker = inTracker;
  }
  ...
  void SetLog(CF::StrPtrLen * /*logname*/) {}
 ...
 private:
  ...
  UInt32
      fNumAcksForMissingPackets;  // how many acks received in the case where the packet was not in the list
