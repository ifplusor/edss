...
class RTPSessionInterface : public QTSSDictionary, public Task {
 public:
  ...
  void SetChallengeParams(QTSS_AuthScheme scheme,
                          UInt32 qop,
                          bool newNonce,
                          bool createOpaque);
  ...
  void UpdateDigestAuthChallengeParams(bool newNonce,
                                       bool createOpaque,
                                       UInt32 qop);
 ...
 private:
  ...
  char fFullRequestURL[kFullRequestURLBufferSize
  ];     // eg rtsp://yourdomain.com/foo/bar.mov
