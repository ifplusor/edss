...
class RTPStream : public QTSSDictionary, public CF::Net::UDPDemuxerTask {
 public:
  ...
  void ProcessIncomingRTCPPacket(CF::StrPtrLen *inPacket);
  ...
  void SetLateTolerance(Float32 inLateToleranceInSec) {
    fLateToleranceInSec = inLateToleranceInSec;
  }
 ...
 private:
  ...
  enum {
    rtp = 0, rtcpSR = 1, rtcpRR = 2, rtcpACK = 3, rtcpAPP = 4
  };
  ...
  bool TestRTCPPackets(CF::StrPtrLen *inPacketPtr, UInt32 itemName);
