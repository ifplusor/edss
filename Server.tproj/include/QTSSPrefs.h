...
class QTSSPrefs : public QTSSDictionary {
 public:
  ...
  //
  // ACCESSORS
  CF::Core::Mutex *GetMutex() { return &fPrefsMutex; }
 ...
 protected:
  ...
  void SetPrefValue(QTSS_AttributeID inAttrID,
                    UInt32 inAttrIndex,
                    char *inPrefValue,
