...
class QTSServerPrefs : public QTSSPrefs {
 public:
  ...
  CF::StrPtrLen *GetRTSPTimeoutAsString() { return &fRTSPTimeoutString; }
  ...
  bool IsPathInsideReliableUDPDir(CF::StrPtrLen *inPath);
  ...
  void GetTransportSrcAddr(CF::StrPtrLen *ioBuf);
  ...
  bool PrintRTPHeaders() {
    return (bool) (fPacketHeaderPrintfOptions & kRTPALL);
  }
  bool PrintSRHeaders() {
    return (bool) (fPacketHeaderPrintfOptions & kRTCPSR);
  }
  bool PrintRRHeaders() {
    return (bool) (fPacketHeaderPrintfOptions & kRTCPRR);
  }
  bool PrintAPPHeaders() {
    return (bool) (fPacketHeaderPrintfOptions & kRTCPAPP);
  }
  bool PrintACKHeaders() {
    return (bool) (fPacketHeaderPrintfOptions & kRTCPACK);
  }
 ...
 private:
  ...
  CF::StrPtrLen fRTSPTimeoutString;
