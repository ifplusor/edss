...
class QTSSErrorLogStream : public QTSSStream, public CF::AssertLogger {
 public:
  ...
  QTSS_Error Write(void *inBuffer, UInt32 inLen, UInt32 *outLenWritten, UInt32 inFlags) override;

  void LogAssert(char *inMessage) override;
};

/**
 * QTSServerInterface 类属于 DSS server core,它基于 QTSSDictionary 类。
 *
 * QTSServer 是 QTSServerInterface 的继承类,在 StartServer 函数里创建 QTSServer 类对象的时候,
 * 必然会创建 QTSServerInterface 类对象。
 */
class QTSServerInterface : public QTSSDictionary {
 public:
  ...
  CF::RefTable *GetRTPSessionMap() { return fRTPMap; }

  CF::RefTable *GetReflectorSessionMap() { return fReflectorSessionMap; }
  ...
  CF::Net::UDPSocketPool *GetSocketPool() { return fSocketPool; }
  ...
  static CF::StrPtrLen &GetServerName() { return sServerNameStr; }

  static CF::StrPtrLen &GetServerVersion() { return sServerVersionStr; }

  static CF::StrPtrLen &GetServerPlatform() { return sServerPlatformStr; }

  static CF::StrPtrLen &GetServerBuildDate() { return sServerBuildDateStr; }

  static CF::StrPtrLen &GetServerHeader() { return sServerHeaderPtr; }

  static CF::StrPtrLen &GetServerBuild() { return sServerBuildStr; }

  static CF::StrPtrLen &GetServerComment() { return sServerCommentStr; }

  //
  // PUBLIC HEADER
  static CF::StrPtrLen *GetPublicHeader() { return &sPublicHeaderStr; }
  ...
  CF::Core::Mutex *GetServerObjectMutex() { return &fMutex; }
 ...
 protected:
  ...
  CF::Net::UDPSocketPool *fSocketPool;

  // All RTP sessions are put into this map
  CF::RefTable *fRTPMap;
  CF::RefTable *fReflectorSessionMap;
  ...
  CF::Net::TCPListenerSocket **fListeners;
  ...
  static CF::ResizeableStringFormatter sPublicHeaderFormatter;
  static CF::StrPtrLen sPublicHeaderStr;
 ...
 private:
  ...
  static CF::StrPtrLen sServerNameStr;
  static CF::StrPtrLen sServerVersionStr;
  static CF::StrPtrLen sServerBuildStr;
  static CF::StrPtrLen sServerCommentStr;
  static CF::StrPtrLen sServerPlatformStr;
  static CF::StrPtrLen sServerBuildDateStr;
  static char sServerHeader[kMaxServerHeaderLen];
  static CF::StrPtrLen sServerHeaderPtr;
