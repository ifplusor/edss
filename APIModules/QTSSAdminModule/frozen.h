...
struct json_token {
  char const *ptr;      /* Points to the beginning of the token */
...
int parse_json(char const *json_string, int json_string_length,
               struct json_token *tokens_array, int size_of_tokens_array);
struct json_token *parse_json2(char const *json_string, int string_length);
...
int json_emit_quoted_str(char *buf, int buf_len, char const *str, int len);
int json_emit_unquoted_str(char *buf, int buf_len, char const *str, int len);
int json_emit(char *buf, int buf_len, char const *fmt, ...);
int json_emit_va(char *buf, int buf_len, char const *fmt, va_list);
