...
class MP3SessionRefKey {
 ...
 private:
  ...
  friend int operator==(const MP3SessionRefKey &key1,
                        const MP3SessionRefKey &key2) {
...
typedef OSHashTableIter<MP3SessionRef, MP3SessionRefKey>
    MP3SessRefHashTableIter;
...
class MP3ClientQueue {
 public:
  ...
  QTSS_Error AddClient(QTSS_RTSPSessionObject clientsess,
                       QTSS_StreamRef clientstream,
                       MP3BroadcasterSession *owner);
...
class MP3BroadcasterQueue {
 public:
  ...
  QTSS_Error CreateBroadcaster(QTSS_RTSPSessionObject bcastsess,
                               QTSS_StreamRef bcaststream,
                               StrPtrLen &mountpt);
